...
# alldg_3_vars is the name of the real RNA-seq data that was modified to create the mat500.RDS, mat200.RDS, and mat100.RDS synthetic count data sets
# The code commented out below makes synthetic data using the seqgendiff package.
...
#V11 = data %>% dplyr::select(!!predictor)
...
ampute_i = ampute_i %>% mutate(V1 = as.factor(V1),
                               V2 = as.factor(V2),
                               V3 = as.factor(V3),
                               V4 = as.factor(V4),
                               V5 = as.factor(V5)) 
...
savename1 = paste0("truth_vs_impute_syn_",miss_mech, "_", predictor, "_", as.character(prop_miss), "_synthetic_data_10_cor_2000_genes_200")
...
savename2 = paste0("truth_vs_cc_syn_",miss_mech, "_", predictor, "_", as.character(prop_miss), "_synthetic_data_10_cor_2000_genes_200")
saveRDS(truth_vs_cc, savename2) 
}
...
savename1 = paste0("truth_vs_impute_syn_",miss_mech, "_", predictor, "_", as.character(prop_miss), "_synthetic_data_10_cor_2000_genes_100")
...
savename2 = paste0("truth_vs_cc_syn_",miss_mech, "_", predictor, "_", as.character(prop_miss), "_synthetic_data_10_cor_2000_genes_100")
saveRDS(truth_vs_cc, savename2) 
}
